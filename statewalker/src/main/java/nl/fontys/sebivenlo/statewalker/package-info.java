/**
 * A Java 8 enum based state machine implementation of the <strong>GoF State</strong>
 * pattern.
 *
 ...
 * list is an array too. We consider using {@code varargs} to be applicable here. If the
